...
public final class ANoVarsNoParamsDecfonc extends PDecfonc
{
    ...
    public Object clone()
    {
        return new ANoVarsNoParamsDecfonc(
    ...
    {
        ((Analysis) sw).caseANoVarsNoParamsDecfonc(this);
    }
