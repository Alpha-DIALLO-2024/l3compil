...
public final class AEcrireFunctionCall extends PFunctionCall
{
    ...
    public Object clone()
    {
        return new AEcrireFunctionCall(
    ...
    {
        ((Analysis) sw).caseAEcrireFunctionCall(this);
    }
