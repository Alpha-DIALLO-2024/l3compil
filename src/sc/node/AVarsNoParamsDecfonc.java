...
public final class AVarsNoParamsDecfonc extends PDecfonc
{
    ...
    public Object clone()
    {
        return new AVarsNoParamsDecfonc(
    ...
    {
        ((Analysis) sw).caseAVarsNoParamsDecfonc(this);
    }
